...
topologia não foi alterada signitivamente face ao trabalho proposto.
...
Uma vez que se tratam de arquivos de grande dimensão decidímos anexar ao 
relatório um arquivo com todos estes registos. No entanto, eles estão organizados
em sessões como se segue:
